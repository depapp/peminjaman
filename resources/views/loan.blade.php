...
<div class="nav-outer"> 
		...
		<ul class="current"><li><a href="<?php echo url ('loan');?>"><b>Loan</b><!--[if IE 7]><!--></a><!--<![endif]-->
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					...
					<th class="table-header-repeat line-left"><a>Fakultas</a></th>
					<th class="table-header-repeat line-left"><a>Institusi</a></th>
					<th class="table-header-repeat line-left"><a>No. Telp</a></th>
					<th class="table-header-repeat line-left"><a>Alat</a></th>
					<th class="table-header-repeat line-left"><a>Tanggal Pinjam</a></th>
					<th class="table-header-repeat line-left"><a>Tanggal Kembali</a></th>
				...
				<tr>
					...
					<a href="{{route('loan.update',$loan->id)}}" title="Approve" class="icon-5 info-tooltip"></a>
					<a href="{{route('loan.destroy',$loan->id)}}" title="cencel" class="icon-2 info-tooltip"></a>
