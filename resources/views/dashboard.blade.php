...
<div class="nav-outer"> 
		...
		<ul class="current"><li><a href="<?php echo url ('dashboard');?>"><b>Dashboard</b><!--[if IE 7]><!--></a><!--<![endif]-->
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					...
					<a href="{{route('article.destroy',$article->id)}}" title="Delete" class="icon-2 info-tooltip"></a>
