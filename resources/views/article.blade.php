					...
					<div class="wrapper">
						<div class="col-1">
							<div class="indent">
								...
								@foreach ($articles as $article)
								<ul class="list1">	
									<li><img src="{{ asset('images/' . $article->img) }}" alt="" width="100" height="110" /><strong><a href="{{ action('ArticleController@viewArticle', $article->id) }}">{{ $article->title }}</a></strong>
										<div style="text-align:justify"><p>{{ $articles->content }}....</div></li>
									</ul>
								@endforeach
							</div>
						</div>
