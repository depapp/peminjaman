...
<div class="nav-outer"> 
		...
		<ul class="current"><li><a href="<?php echo url ('addAsisstant');?>"><b>Assistant</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<div class="select_sub show">
			<ul class="sub">
				<li><a href="<?php echo url ('listAsisstant');?>">List Asisstant</a></li>
				<li class="sub_show"><a href="<?php echo url ('addAsisstant');?>">Add Assistant</a></li>
...
<div id="page-heading"><h1>Add Assistant</h1></div>
...
<tr>
	...
	<td>
		...
		<!-- start id-form -->
		{!! Form::open(['url'=>'addAsisstant','files' => true])!!}
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
		<tr>
			<th valign="top">Nama:</th>
			<td><input type="text" class="inp-form" name="nama"/ required="required"></td>
			<td></td>
		</tr>
		<tr>
			<th valign="top">Nim:</th>
			<td><input type="text" class="inp-form" name="nim" required="required"/></td>
			<td></td>
		</tr>
		<tr>
			<th valign="top">Jurusan:</th>
			<td><input type="text" class="inp-form" name="jurusan" required="required"/></td>
			<td></td>
		</tr>
		<tr>
			<th valign="top">Angkatan:</th>
			<td><input type="text" class="inp-form" name="angkatan" required="required"/></td>
			<td></td>
		</tr>
		<tr>
			<th valign="top">No. Hp:</th>
			<td><input type="text" class="inp-form" name="hp" required="required"/></td>
			<td></td>
		</tr>
		<tr>
		...
		<td>	
		<select  class="styledselect_form_1" name="divisi">
	...
	<tr>
		...
		<td><textarea rows="" cols="" class="form-textarea" name="deskripsi" required="required"></textarea></td>
		<td></td>
	</tr>
	<tr>
	<th>Foto:</th>
	<td><input type="file" class="file_1" name="foto" required="required"/></td>
	</tr>
	<tr>
		<th>&nbsp;</th>
		<td valign="top">
